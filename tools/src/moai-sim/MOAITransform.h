...
protected:
	...
	static int	_getLocX		( lua_State* L );
	static int	_getLocY		( lua_State* L );
	static int	_getLocZ		( lua_State* L );
	static int	_getPiv			( lua_State* L );
	static int	_getPivX		( lua_State* L );
	static int	_getPivY		( lua_State* L );
	static int	_getPivZ		( lua_State* L );
	static int	_getRot			( lua_State* L );
	static int	_getRotX		( lua_State* L );
	static int	_getRotY		( lua_State* L );
	static int	_getRotZ		( lua_State* L );
	static int	_getScl			( lua_State* L );
	static int	_getSclX		( lua_State* L );
	static int	_getSclY		( lua_State* L );
	static int	_getSclZ		( lua_State* L );
	...
	static int	_setLocX		( lua_State* L );
	static int	_setLocY		( lua_State* L );
	static int	_setLocZ		( lua_State* L );
	static int	_setPiv			( lua_State* L );
	static int	_setPivX		( lua_State* L );
	static int	_setPivY		( lua_State* L );
	static int	_setPivZ		( lua_State* L );
	static int	_setRot			( lua_State* L );
	static int	_setRotX		( lua_State* L );
	static int	_setRotY		( lua_State* L );
	static int	_setRotZ		( lua_State* L );
	static int	_setScl			( lua_State* L );
	static int	_setSclX		( lua_State* L );
	static int	_setSclY		( lua_State* L );
	static int	_setSclZ		( lua_State* L );
