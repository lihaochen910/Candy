...
//----------------------------------------------------------------//
/**	@lua	stepSim
	@text	Manual update all.

	@in		number step			Delta time.
	@out	nil
*/
int MOAISim::_stepSim( lua_State *L ) {
...
//----------------------------------------------------------------//
/**	@lua	setBufferSize
	@text	Setup up the window size.

	@in		number width		The width of the window in pixels.
	@in		number height		The height of the window in pixels.
	@out	nil
*/
int MOAISim::_setBufferSize( lua_State *L ) {
...
//----------------------------------------------------------------//
/**	@lua	stepSim
	@text	Render the given framebuffer.

	@in		MOAIFrameBuffer frameBuffer			Frame Buffer.
	@out	nil
*/
int MOAISim::_renderFrameBuffer( lua_State *L ) {
