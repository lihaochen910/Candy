...
from candy_editor.moai.MOAIRuntime \
	import LuaTableProxy, _G, _LuaTable, _LuaObject, _CANDY
...
class CandyRuntime ( EditorModule ):
	...
	def postDeploy ( self, context ):
		...
		data[ 'texture_library' ] = context.meta.get ( 'candy_texture_library', False )
		data[ 'script_library' ] = context.meta.get ( 'candy_script_library', False )
