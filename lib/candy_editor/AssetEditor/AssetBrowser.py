...
from candy_editor.qt.dialogs.Dialogs   import requestString, alertMessage, requestConfirm
from candy_editor.qt.helpers   import setClipboardText
# from candy_editor.qt.controls.SearchView import requestSearchView, registerSearchEnumerator

from .AssetEditor      import getAssetSelectionManager
...
class AssetBrowserInstance ( object ):
	...
	def onLoad ( self ):
		...
		self.window = self.module.requestToolWindow (
				'AssetBrowser',
				title   = 'Assets',
				area    = dock,
				minSize = (200,200)
