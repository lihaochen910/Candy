...
from candy_editor.qt.controls.ToolWindowManager.ToolWindowManagerWrapper import ToolWindowManagerWrapper
...
if __name__ == '__main__':
	...
	class Test ( QtWidgets.QMainWindow ):
		def __init__ (self, *args ):
			...
			# widget = QtWidgets.QPushButton ( 'new' )
			# widget.setWindowTitle ( 'new' )
			# widget.setObjectName ( 'new' )
			# mgr.addToolWindow ( widget, ToolWindowManager.AddTo )
