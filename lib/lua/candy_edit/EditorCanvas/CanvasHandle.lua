...
-- module
local CanvasHandleModule = {}

--------------------------------------------------------------------
---@class CanvasHandleLayer : EditorEntity
local CanvasHandleLayer = CLASS: CanvasHandleLayer ( candy.EditorEntity )
...
local CanvasHandle = CLASS: CanvasHandle ( candy.EditorEntity )
...
CanvasHandleModule.CanvasHandleLayer = CanvasHandleLayer
CanvasHandleModule.CanvasHandle = CanvasHandle

return CanvasHandleModule