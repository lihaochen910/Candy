-- import
local Camera = require "candy.gfx.Camera"
local Scene = require "candy.Scene"

-- module
local EditorCanvasSceneModule = {}

--------------------------------------------------------------------
--EditorCanvasCamera
--------------------------------------------------------------------
---@class EditorCanvasCamera : Camera
local EditorCanvasCamera = CLASS: EditorCanvasCamera ( Camera )
...
function EditorCanvasCamera:onAttach ( entity )
	...
	return candy.Camera.onAttach ( self, entity )
end
...
--EditorCanvasScene
--------------------------------------------------------------------
---@class EditorCanvasScene : Scene
local EditorCanvasScene = CLASS: EditorCanvasScene ( Scene )
...
function EditorCanvasScene:onLoad ()
	...
	self.cameraEntity = candy.Entity ()
	self.cameraEntity.FLAG_EDITOR_OBJECT = true
	self.cameraEntity:attach (self.cameraCom)
	self:addEntity ( self.cameraEntity )
end
...
--------------------------------------------------------------------
local function createEditorCanvasInputDevice ( env )
...
---------------------------------------------------------------------
local function createEditorCanvasScene ()
	local env = getfenv ( 2 )
...
EditorCanvasSceneModule.EditorCanvasCamera = EditorCanvasCamera
EditorCanvasSceneModule.EditorCanvasScene = EditorCanvasScene
EditorCanvasSceneModule.createEditorCanvasInputDevice = createEditorCanvasInputDevice
EditorCanvasSceneModule.createEditorCanvasScene = createEditorCanvasScene

return EditorCanvasSceneModule