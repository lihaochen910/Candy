...
-- module
local InputCommandMappingModule = {}

--------------------------------------------------------------------
local _inputCommandMappingManager = nil
...
local InputCommandMapping = CLASS: InputCommandMapping ()
...
function InputCommandMapping:load ( config )
	...
	SignalModule.emitGlobalSignal ( "input.mapping.change", self )
end
...
function InputCommandMapping:onKeyEvent ( key, down, mockup )
	...
	if cmd then
		return self:sendCommandEvent ( cmd, down, "keyboard", {
			key = key
		}, mockup )
	end
end
...
function InputCommandMapping:onMouseButtonEvent ( btn, down, mockup )
	...
	if cmd then
		return self:sendCommandEvent ( cmd, down, "mouse", {
			button = btn
		}, mockup )
	end
end
...
function InputCommandMapping:onJoystickButtonEvent ( joy, btn, down, mockup )
	...
	if cmd then
		return self:sendCommandEvent ( cmd, down, "joystick", {
			joy = joy,
			button = btn
		}, mockup )
	end
...
function InputCommandMapping:sendCommandEvent ( cmd, down, source, sourceData, mockup )
	...
	if self.currentSource ~= source then
		...
		SignalModule.emitGlobalSignal ( "input.source.change", self, source )
...
function InputCommandMapping:pollCommandHit ( cmd )
...
--------------------------------------------------------------------
-- InputCommandMappingManager
--------------------------------------------------------------------
---@class InputCommandMappingManager : GlobalManager
local InputCommandMappingManager = CLASS: InputCommandMappingManager ( GlobalManager )
	:MODEL {}
...
InputCommandMappingModule.InputCommandMapping = InputCommandMapping
InputCommandMappingModule.InputCommandMappingManager = InputCommandMappingManager
InputCommandMappingModule.getInputCommandMappingManager = getInputCommandMappingManager
InputCommandMappingModule.isNavigationInputCommand = isNavigationInputCommand
InputCommandMappingModule.getDefaultInputCommandMapping = getDefaultInputCommandMapping
InputCommandMappingModule.getDefaultUIInputCommandMapping = getDefaultUIInputCommandMapping
InputCommandMappingModule.getInputCommandMapping = getInputCommandMapping
InputCommandMappingModule.affirmInputCommandMapping = affirmInputCommandMapping
InputCommandMappingModule.isInputCommandDown = isInputCommandDown
InputCommandMappingModule.isInputCommandUp = isInputCommandUp

return InputCommandMappingModule