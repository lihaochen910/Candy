...
function TaskQueue:notifyFail ( task )
	assert ( self.activeTask == task )
...
TaskModule.TaskManager = TaskManager
TaskModule.TaskGroup = TaskGroup
TaskModule.TaskQueue = TaskQueue
TaskModule.Task = Task
TaskModule.getTaskManager = getTaskManager
TaskModule.isTaskGroupBusy = isTaskGroupBusy
TaskModule.getTaskGroup = getTaskGroup
TaskModule.getTaskProgress = getTaskProgress
