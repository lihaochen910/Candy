...
-- module
local EntityMessageAnimatorTrackModule = {}

---@class EntityMessageAnimatorKey : AnimatorEventKey
local EntityMessageAnimatorKey = CLASS: EntityMessageAnimatorKey ( AnimatorEventKey )
	:MODEL {
		Field ( "msg" ):string (),
		Field ( "data" ):string ()
	}
...
local EntityMessageAnimatorTrack = CLASS: EntityMessageAnimatorTrack ( AnimatorEventTrack )
	:MODEL {}
...
EntityMessageAnimatorTrackModule.EntityMessageAnimatorKey = EntityMessageAnimatorKey
EntityMessageAnimatorTrackModule.EntityMessageAnimatorTrack = EntityMessageAnimatorTrack

return EntityMessageAnimatorTrackModule