...
local AnimatorClipTreeNodeSelect = CLASS: AnimatorClipTreeNodeSelect ( AnimatorClipTreeNode )
	:MODEL {
...
local AnimatorClipTreeNodeSelectCase = CLASS: AnimatorClipTreeNodeSelectCase ( AnimatorClipTreeNode )
	:MODEL {
		Field ( "value" ):string ()
	}
...
local function makeConditionChecker ( var, cond )
	local head = string.format ( "local isn, getvar=...; return function ( state ) local v=getvar ( state,%q );", var )
	local body = nil
...
function AnimatorClipTreeNodeSelectCase:onBuild ( context )
	...
	if not parent:isInstance ( AnimatorClipTreeNodeSelect ) then
		return
	end
...
local AnimatorClipTreeNodeSelectCaseDefault = CLASS: AnimatorClipTreeNodeSelectCaseDefault ( AnimatorClipTreeNodeSelectCase )
	:MODEL {
...
AnimatorClipTreeNodeSelectModule.AnimatorClipTreeNodeSelect = AnimatorClipTreeNodeSelect
AnimatorClipTreeNodeSelectModule.AnimatorClipTreeNodeSelectCase = AnimatorClipTreeNodeSelectCase
AnimatorClipTreeNodeSelectModule.AnimatorClipTreeNodeSelectCaseDefault = AnimatorClipTreeNodeSelectCaseDefault

return AnimatorClipTreeNodeSelectModule