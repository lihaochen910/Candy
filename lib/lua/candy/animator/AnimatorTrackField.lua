...
local AnimatorTrackField = CLASS: AnimatorTrackField ( AnimatorValueTrack ) :MODEL ( {
...
function AnimatorTrackField:build ( context )
...
function AnimatorTrackField:onCollectObjectRecordingState ( animator, retainedState )
	local rootEntity = animator._entity
	local scene = animator._entity.scene
	local target = self.targetPath:get ( rootEntity, scene )
