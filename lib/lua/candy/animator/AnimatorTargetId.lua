-- module
local AnimatorTargetIdModule = {}

local insert = table.insert

---@class AnimatorTargetId
local AnimatorTargetId = CLASS: AnimatorTargetId ()
	:MODEL {}
...
local AnimatorTargetPath = CLASS: AnimatorTargetPath ()
	:MODEL {}
...
function AnimatorTargetPath.buildForEntity ( target, relativeTo )
	...
	if target:isChildOf ( relativeTo ) then
...
local AnimatorComponentId = CLASS: AnimatorComponentId ( AnimatorTargetId ):MODEL {}

function AnimatorComponentId:__init ()
...
function AnimatorComponentId:toString ()
	return self.targetClas and self.targetClas.__name .. "[ " .. self.index .. " ]" or "???"
end
...
local AnimatorChildEntityId = CLASS: AnimatorChildEntityId ( AnimatorTargetId )
	:MODEL {}
...
local AnimatorThisEntityId = CLASS: AnimatorThisEntityId ( AnimatorChildEntityId )
...
local AnimatorGlobalEntityId = CLASS: AnimatorGlobalEntityId ( AnimatorChildEntityId ):MODEL {}
...
AnimatorTargetIdModule.AnimatorTargetId = AnimatorTargetId
AnimatorTargetIdModule.AnimatorTargetPath = AnimatorTargetPath
AnimatorTargetIdModule.AnimatorComponentId = AnimatorComponentId
AnimatorTargetIdModule.AnimatorChildEntityId = AnimatorChildEntityId
AnimatorTargetIdModule.AnimatorThisEntityId = AnimatorThisEntityId
AnimatorTargetIdModule.AnimatorGlobalEntityId = AnimatorGlobalEntityId

return AnimatorTargetIdModule