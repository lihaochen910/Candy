...
-- module
local AnimatorTrackFieldColorModule = {}

---@class AnimatorTrackColorComponent : AnimatorValueTrack
local AnimatorTrackColorComponent = CLASS: AnimatorTrackColorComponent ( AnimatorValueTrack ) :MODEL ( {
...
local AnimatorTrackFieldColor = CLASS: AnimatorTrackFieldColor ( AnimatorTrackField )
...
function AnimatorTrackFieldColor:build ( context )
...
function AnimatorTrackFieldColor:isEmpty ()
	return self:getComponentTrack ( 1 ):isEmpty () and self:getComponentTrack ( 2 ):isEmpty () and self:getComponentTrack ( 3 ):isEmpty () and self:getComponentTrack ( 4 ):isEmpty ()
end

function AnimatorTrackFieldColor:calcLength ()
	local length = math.max ( self:getComponentTrack ( 1 ):calcLength (), self:getComponentTrack ( 2 ):calcLength (), self:getComponentTrack ( 3 ):calcLength (), self:getComponentTrack ( 4 ):calcLength () )
	return length
end
...
AnimatorTrackFieldColorModule.AnimatorTrackColorComponent = AnimatorTrackColorComponent
AnimatorTrackFieldColorModule.AnimatorTrackFieldColor = AnimatorTrackFieldColor

return AnimatorTrackFieldColorModule