...
-- module
local AnimatorTrackFieldVecModule = {}

---@class AnimatorTrackVecComponent : AnimatorValueTrack
local AnimatorTrackVecComponent = CLASS: AnimatorTrackVecComponent ( AnimatorValueTrack )
	:MODEL {
...
local AnimatorTrackFieldVecCommon = CLASS: AnimatorTrackFieldVecCommon ( AnimatorTrackField )
...
function AnimatorTrackFieldVecCommon:isEmpty ()
	return self:getComponentTrack ( 1 ):isEmpty () and self:getComponentTrack ( 2 ):isEmpty () and self:getComponentTrack ( 3 ):isEmpty ()
end

function AnimatorTrackFieldVecCommon:build ( context )
...
function AnimatorTrackFieldVecCommon:calcLength ()
	local length = math.max ( self:getComponentTrack ( 1 ):calcLength (), self:getComponentTrack ( 2 ):calcLength (), self:getComponentTrack ( 3 ):calcLength () )
	return length
end
...
local AnimatorTrackFieldVec3 = CLASS: AnimatorTrackFieldVec3 ( AnimatorTrackFieldVecCommon )
...
function AnimatorTrackFieldVec3:build ( context )
	self.curveX = self:getComponentTrack ( 1 ):buildCurve ()
	self.curveY = self:getComponentTrack ( 2 ):buildCurve ()
	self.curveZ = self:getComponentTrack ( 3 ):buildCurve ()
	context:updateLength ( self:calcLength () )
...
local AnimatorTrackFieldVec2 = CLASS: AnimatorTrackFieldVec2 ( AnimatorTrackFieldVecCommon )
...
function AnimatorTrackFieldVec2:build ( context )
	self.curveX = self:getComponentTrack ( 1 ):buildCurve ()
	self.curveY = self:getComponentTrack ( 2 ):buildCurve ()
	context:updateLength ( self:calcLength () )
end
...
function AnimatorTrackFieldVec2:isEmpty ()
	return self:getComponentTrack ( 1 ):isEmpty () and self:getComponentTrack ( 2 ):isEmpty ()
end

function AnimatorTrackFieldVec2:calcLength ()
	local length = math.max ( self:getComponentTrack ( 1 ):calcLength (), self:getComponentTrack ( 2 ):calcLength () )
	return length
end

AnimatorTrackFieldVecModule.AnimatorTrackVecComponent = AnimatorTrackVecComponent
AnimatorTrackFieldVecModule.AnimatorTrackFieldVecCommon = AnimatorTrackFieldVecCommon
AnimatorTrackFieldVecModule.AnimatorTrackFieldVec3 = AnimatorTrackFieldVec3
AnimatorTrackFieldVecModule.AnimatorTrackFieldVec2 = AnimatorTrackFieldVec2

return AnimatorTrackFieldVecModule