...
local AnimatorClipTreeState = CLASS: AnimatorClipTreeState ()
...
local AnimatorClipTreeNode = CLASS: AnimatorClipTreeNode ()
	:MODEL {
...
---@class AnimatorClipTreeNode : AnimatorClipTreeNode
local AnimatorClipTreeNodeRoot = CLASS: AnimatorClipTreeNodeRoot ( AnimatorClipTreeNode ):MODEL {}
...
local AnimatorClipTreeTrack = CLASS: AnimatorClipTreeTrack ( AnimatorTrack )
...
local AnimatorClipTree = CLASS: AnimatorClipTree ( AnimatorClip )
	:MODEL ( {
...
AnimatorClipTreeModule.AnimatorClipTreeState = AnimatorClipTreeState
AnimatorClipTreeModule.AnimatorClipTreeNode = AnimatorClipTreeNode
AnimatorClipTreeModule.AnimatorClipTreeNodeRoot = AnimatorClipTreeNodeRoot
AnimatorClipTreeModule.AnimatorClipTreeTrack = AnimatorClipTreeTrack
AnimatorClipTreeModule.AnimatorClipTree = AnimatorClipTree

return AnimatorClipTreeModule