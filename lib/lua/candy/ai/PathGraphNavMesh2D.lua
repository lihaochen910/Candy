...
local PathGraph = PathFinderModule.PathGraph

local insert = table.insert

---@class PathGraphNavMesh2D : PathGraph
local PathGraphNavMesh2D = CLASS: PathGraphNavMesh2D ( PathGraph )
	:MODEL {}
...
function PathGraphNavMesh2D:buildNavigatePath ( request, nodePath )
	...
	local naviPath = self.pathGraph:findNavigationPath ( x0, y0, x1, y1, nodePath )
	local naviPath2 = {}
