...
local PathGraph = PathFinderModule.PathFinder

-- module
local WaypointPathGraphModule = {}

local insert = table.insert

local WaypointPathGraph

---@class WaypointGraphContainer : Component
local WaypointGraphContainer = CLASS: WaypointGraphContainer ( Component )
	:MODEL ( {
...
ComponentModule.registerComponent ( "WaypointGraphContainer", WaypointGraphContainer )
...
WaypointPathGraph = CLASS: WaypointPathGraph ( PathGraph )
	:MODEL {}
...
local WaypointPathFinder = CLASS: WaypointPathFinder ( Component )
	:MODEL {}
	:DEPRECATED ()


WaypointPathGraphModule.WaypointGraphContainer = WaypointGraphContainer
WaypointPathGraphModule.Waypoint = Waypoint
WaypointPathGraphModule.WaypointPathGraph = WaypointPathGraph
WaypointPathGraphModule.WaypointPathFinder = WaypointPathFinder

return WaypointPathGraphModule