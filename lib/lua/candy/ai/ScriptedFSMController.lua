...
local ScriptedFSMController = CLASS: ScriptedFSMController ( FSMController )
	:MODEL {
		Field ( "script" ):asset ( "com_script" ):getset ( "Script" )
	}

ComponentModule.registerComponent ( "ScriptedFSMController", ScriptedFSMController )
...
function ScriptedFSMController:updateComponentScript ()
	...
	local delegate, dataInstance = nil
