...
function Layer:setName ( name )
	self.name = name
	SignalModule.emitSignal ( 'layer.update', self, 'name' )
end
...
function Layer:setVisible ( visible )
	SignalModule.emitSignal ( 'layer.update', self, 'visible' )
...
function Layer:setEditorVisible ( visible )
	...
	SignalModule.emitSignal ( 'layer.update', self, 'editor_visible' )
end
...
function Layer:setSortMode ( mode )
	self.sortMode = mode
	SignalModule.emitSignal ( 'layer.update', self, 'sort' )
end
...
function Layer:makeMoaiLayer ( partition )
	local layer = RenderManagerModule.createPartitionRenderLayer ()
	-- layer:setKeepResultBuffer ( true ) -- TODO: no setKeepResultBuffer function
