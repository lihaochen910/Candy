...
local UISliderHandle = CLASS: UISliderHandle ( UIButtonBase )
	:MODEL {}
...
local UISliderSlot = CLASS: UISliderSlot ( UIButtonBase )
	:MODEL {}
...
local UISlider = CLASS: UISlider ( UIButtonBase )
	:MODEL {
...
function UISlider:setValue ( v )
	local r0 = self.minValue
	local r1 = self.maxValue
...
local UIHSlider = CLASS: UIHSlider ( UISlider )
	:MODEL {}
...
local UIVSlider = CLASS: UIVSlider ( UISlider )
	:MODEL {}
...
EntityModule.registerEntity ( "UIHSlider", UIHSlider )
EntityModule.registerEntity ( "UIVSlider", UIVSlider )

UISliderModule.UISliderHandle = UISliderHandle
UISliderModule.UISliderSlot = UISliderSlot
UISliderModule.UISlider = UISlider
UISliderModule.UIHSlider = UIHSlider
UISliderModule.UIVSlider = UIVSlider
