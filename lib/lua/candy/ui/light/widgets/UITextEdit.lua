...
local TextObject = require 'candy.tools.TextObject'
local EntityModule = require 'candy.Entity'

-- module
local UITextEditModule = {}

--------------------------------------------------------------------
-- UIButtonBase
--------------------------------------------------------------------
---@class UITextSelectionRenderer : DrawScript
local UITextSelectionRenderer = CLASS: UITextSelectionRenderer ( DrawScript )
...
local UITextEditCursor = CLASS: UITextEditCursor ( DrawScript )
...
function UITextEditCursor:getSelection ()
	local s = self.selectionStart
	local e = self.selectionEnd
...
local UITextEditRenderer = CLASS: UITextEditRenderer ( UICommonStyleWidgetRenderer )
	:MODEL {}
...
local UITextEdit = CLASS: UITextEdit ( UIWidget )
	:MODEL {}

EntityModule.registerEntity ( "UITextEdit", UITextEdit )
...
function UITextEdit:procKeyDown ( ev )
	...
	local selecting = modifiers.shift and true or false
	...
	elseif key == "enter" or key == "return" then
		cursor:insert ( "\n" )
	elseif key == "a" and modifiers.ctrl then
	...
	elseif key == "z" and modifiers.ctrl then
		self:undo ()
	end
end
...
UITextEditModule.UITextSelectionRenderer = UITextSelectionRenderer
UITextEditModule.UITextEditCursor = UITextEditCursor
UITextEditModule.UITextEditRenderer = UITextEditRenderer
UITextEditModule.UITextEdit = UITextEdit

return UITextEditModule