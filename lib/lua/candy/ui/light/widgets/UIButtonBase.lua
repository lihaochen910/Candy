...
local UIMsgSource = UIMsgModule.UIMsgSource
local ComponentModule = require 'candy.Component'

-- module
local UIButtonBaseModule = {}

--------------------------------------------------------------------
-- UIButtonBase
--------------------------------------------------------------------
---@class UIButtonBase : UIWidget
local UIButtonBase = CLASS: UIButtonBase ( UIWidget )
	:MODEL {}
	:SIGNAL {
		pressed = "onPressed",
		released = "onReleased",
...
function UIButtonBase:procInputCommand ( cmdData )
	...
	if cmd == "confirm" and not cmdData.repeating then
		...
		return true
	elseif cmdData.down and isNavigationInputCommand ( cmd ) then
		self:moveFocus ( cmd )
		return true
	end
end
...
local UIButtonMsg = CLASS: UIButtonMsg ( UIMsgSource )
	:MODEL {
		"----",
...
ComponentModule.registerComponent ( "UIButtonMsg", UIButtonMsg )
...
UIButtonBaseModule.UIButtonBase = UIButtonBase
UIButtonBaseModule.UIButtonMsg = UIButtonMsg

return UIButtonBaseModule