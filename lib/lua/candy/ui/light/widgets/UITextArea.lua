...
local UITextAreaRenderer = require 'candy.ui.light.renderers.UITextAreaRenderer'
local EntityModule = require 'candy.Entity'

---@class UITextArea : UIWidget
local UITextArea = CLASS: UITextArea ( UIWidget )
	:MODEL {
		Field "text" :string () :getset ( "Text" ) :widget ( "textbox" )
	}

EntityModule.registerEntity ( "UITextArea", UITextArea )
