...
local TextLabel = require 'candy.gfx.TextLabel'
local AssetLibraryModule = require 'candy.AssetLibrary'
local AdHocAsset = AssetLibraryModule.AdHocAsset

---@class UIWidgetElementText : UIWidgetElement
local UIWidgetElementText = CLASS: UIWidgetElementText ( UIWidgetElement )
	:MODEL {}

function UIWidgetElementText:__init ()
	self.styleBaseName = ""
	self.text = ""
	self.label = false ---@type TextLabel
