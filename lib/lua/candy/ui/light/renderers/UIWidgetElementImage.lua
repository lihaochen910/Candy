...
local UIWidgetElementImage = CLASS: UIWidgetElementImage ( UIWidgetElement )
	:MODEL {}
...
local function _affirmDeck ( data )
	...
	elseif AssetLibraryModule.isAdHocAsset ( data ) then
		return data
	elseif isInstance ( data, candy.Deck2D ) then
