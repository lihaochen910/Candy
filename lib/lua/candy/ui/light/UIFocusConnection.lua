...
local UIFocusConnection = CLASS: UIFocusConnection ( Component )
	:MODEL {
...
ComponentModule.registerComponent ( "UIFocusConnection", UIFocusConnection )
...
function UIFocusConnection:updateConnections ()
	...
	if not widget:isInstance ( UIWidget ) then
		return
	end
