...
-- import
local CheckBox = require 'candy.ui.CheckBox'
local BaseItemRenderer = require 'candy.ui.BaseItemRenderer'

---@class CheckBoxItemRenderer : BaseItemRenderer
local CheckBoxItemRenderer = CLASS: CheckBoxItemRenderer ( BaseItemRenderer )
