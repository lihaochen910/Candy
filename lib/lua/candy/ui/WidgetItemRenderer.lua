...
local BoxLayout = require 'candy.ui.BoxLayout'
local BaseItemRenderer = require 'candy.ui.BaseItemRenderer'

---@class WidgetItemRenderer : BaseItemRenderer
local WidgetItemRenderer = CLASS: WidgetItemRenderer ( BaseItemRenderer )
...
function WidgetItemRenderer:_updateWidget ()
    ...
    if self._widget:getLayout () and isInstance ( self._widget:getLayout (), BoxLayout ) then
