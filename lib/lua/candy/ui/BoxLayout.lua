...
-- import
local UILayout = require 'candy.ui.UILayout'

---@class BoxLayout : UILayout
local BoxLayout = CLASS: BoxLayout ( UILayout )
...
function BoxLayout:update ( parent )
    ...
    elseif self._direction == BoxLayout.DIRECTION_HORIZONTAL then
        ...
        _warn ( "Illegal direction pattern !", self._direction )
    end
end
