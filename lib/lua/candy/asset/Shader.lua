...
--------------------------------------------------------------------
---@class ShaderProgram
local ShaderProgram = CLASS: ShaderProgram ()
	:MODEL{
		Field 'vsh' :asset( 'vsh' );
		Field 'fsh' :asset( 'fsh' );
	}
...
local MultiShader = CLASS: MultiShader ( Shader )
	:MODEL {}
...
ShaderModule.buildShaderProgramFromString = buildShaderProgramFromString
ShaderModule.ShaderProgram = ShaderProgram
ShaderModule.Shader = Shader
ShaderModule.getLoadedShaderPrograms = getLoadedShaderPrograms
ShaderModule.reportShader = reportShader
ShaderModule.MultiShader = MultiShader
