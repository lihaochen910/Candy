...
--------------------------------------------------------------------
---@class ShaderConfig
local ShaderConfig = CLASS: ShaderConfig ()
...
--------------------------------------------------------------------
---@class ShaderBuilder
local ShaderBuilder = CLASS: ShaderBuilder ()
	:MODEL {}
...
ShaderConfigModule.ShaderConfig = ShaderConfig
ShaderConfigModule.ShaderBuilder = ShaderBuilder

return ShaderConfigModule