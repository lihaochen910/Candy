...
-- module
local MultiTextureModule = {}

--------------------------------------------------------------------
---@class MultiTextureInstance : TextureInstanceBase
local MultiTextureInstance = CLASS: MultiTextureInstance ( TextureBaseModule.TextureInstanceBase )
	:MODEL {}
...
MultiTextureModule.MultiTextureInstance = MultiTextureInstance
MultiTextureModule.createMultiTexture = createMultiTexture
MultiTextureModule.MultiTextureConfigLoader = MultiTextureConfigLoader

return MultiTextureModule