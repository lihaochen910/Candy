...
local ShaderConfig = ShaderConfigModule.ShaderConfig

-- module
local ShaderScriptModule = {}
...
---------------------------------------------------------------------
local ShaderScriptConfig = CLASS: ShaderScriptConfig ( ShaderConfig )
...
AssetLibraryModule.registerAssetLoader ( 'shader_script', ShaderScriptLoader, ShaderScriptUnloader )
...
AssetLibraryModule.registerAssetLoader ( 'fsh', shaderSourceLoader )
AssetLibraryModule.registerAssetLoader ( 'vsh', shaderSourceLoader )
AssetLibraryModule.registerAssetLoader ( 'glsl', shaderSourceLoader )
...
AssetLibraryModule.registerAssetLoader ( 'shader', legacyShaderConfigLoader )
...
ShaderScriptModule._loadShaderScript = _loadShaderScript
ShaderScriptModule.ShaderScriptConfig = ShaderScriptConfig
ShaderScriptModule.buildMasterShader = buildMasterShader
ShaderScriptModule.buildShader = buildShader

return ShaderScriptModule