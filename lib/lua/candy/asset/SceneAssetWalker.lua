...
SceneAssetWalkerModule.collectAssetFromObject = collectAssetFromObject
SceneAssetWalkerModule.collectAssetFromEntity = collectAssetFromEntity
SceneAssetWalkerModule.collectAssetFromGroup = collectAssetFromGroup
SceneAssetWalkerModule.collectAssetFromScene = collectAssetFromScene
SceneAssetWalkerModule.collectGroupAssetDependency = collectGroupAssetDependency

return SceneAssetWalkerModule