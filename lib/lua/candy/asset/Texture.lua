...
local TextureInstanceBase = TextureBaseModule.TextureInstanceBase
local AsyncTextureLoadTaskModule = require 'candy.task.AsyncTextureLoadTask'
local AsyncTextureLoadTask = AsyncTextureLoadTaskModule.AsyncTextureLoadTaskModule
...
local TextureGroup
local Texture
local TextureInstance

--------------------------------------------------------------------
local function makeSolidTexture ( w, h, r,g,b,a )
...
local function getTexturePlaceHolderImage ( w, h )
...
local function getEmptyTexture ()
...
local function getBlackTexture ()
...
local function getTextureLibrary ()
	return textureLibrary
end

local function preloadTextureGroup ( groupName )
	local group = textureLibrary:getGroup ( groupName )
	return group:_preloadAll ()
end

local function initTextureLibrary ( indexPath )
	textureLibrary = TextureLibrary ()
	textureLibrary:initDefault ()
	return textureLibrary
end

local function loadTextureLibrary ( indexPath )
...
--------------------------------------------------------------------
TextureLibrary = CLASS: TextureLibrary ()
TextureGroup = CLASS: TextureGroup ()
...
function Texture:isPrebuiltAtlas ()
	local node = AssetLibraryModule.getAssetNode ( self.path )
	if not node then
...
TextureInstance = CLASS: TextureInstance ( TextureInstanceBase )
	:MODEL {}
...
function TextureGroup:loadTexture ( instance )
	...
	local node = AssetLibraryModule.getAssetNode ( instance:getPath () )
...
function TextureGroup:_loadSingleTexture ( pixmapPath, debugName )
	...
	local filePath = EnvModule.getProjectPath ( pixmapPath )
...
function TextureLibrary:save ( path )
	...
	return SerializerModule.serializeToFile ( self, path )
end
...
--------------------------------------------------------------------
local function releaseTexPack ( cachePath )
end
...
function affirmMoaiTexture ( t )
	...
	elseif tt == "string" then
		local atype = AssetLibraryModule.getAssetType ( t )
		if AssetLibraryModule.isSupportedTextureAssetType ( atype ) then
			local asset = AssetLibraryModule.loadAsset ( t )
...
local function runtimeLoadTexture ( path, option )
	local node = AssetLibraryModule.registerAssetNode ( path, {
			type = 'texture', 
			objectFiles = { pixmap = path } 
		}
	)
...
AssetLibraryModule.registerAssetLoader ( 'texture_pack',    loadTexturePack )
AssetLibraryModule.registerAssetLoader ( 'texture',         loadTexture, unloadTexture )
AssetLibraryModule.registerAssetLoader ( 'prebuilt_atlas',  loadTexture, unloadTexture )

AssetLibraryModule.registerRuntimeAssetLoader ( 'texture', runtimeLoadTexture )
AssetLibraryModule.registerRuntimeAssetTypeHinter ( 'png', 'texture' )
AssetLibraryModule.registerRuntimeAssetTypeHinter ( 'jpg', 'texture' )
AssetLibraryModule.registerRuntimeAssetTypeHinter ( 'jpeg', 'texture' )
AssetLibraryModule.registerRuntimeAssetTypeHinter ( 'bmp', 'texture' )
AssetLibraryModule.registerRuntimeAssetTypeHinter ( 'webp', 'texture' )
AssetLibraryModule.registerRuntimeAssetTypeHinter ( 'psd', 'texture_pack' )


addSupportedTextureAssetType ( 'texture' )


TextureModule.makeSolidTexture = makeSolidTexture
TextureModule.getTexturePlaceHolderImage = getTexturePlaceHolderImage
TextureModule.getWhiteTexture = getWhiteTexture
TextureModule.getEmptyTexture = getEmptyTexture
TextureModule.getBlackTexture = getBlackTexture
TextureModule.getTextureLibrary = getTextureLibrary
TextureModule.preloadTextureGroup = preloadTextureGroup
TextureModule.initTextureLibrary = initTextureLibrary
TextureModule.loadTextureLibrary = loadTextureLibrary
TextureModule.TextureLibrary = TextureLibrary
TextureModule.TextureGroup = TextureGroup
TextureModule.TextureInstance = TextureInstance
TextureModule.Texture = Texture
TextureModule.reportLoadedMoaiTextures = reportLoadedMoaiTextures
TextureModule.getLoadedMoaiTextures = getLoadedMoaiTextures
TextureModule.releaseTexPack = releaseTexPack
