...
local RenderTargetTexture = CLASS: RenderTargetTexture ( TextureInstanceBase )
	:MODEL {
		Field "width" :int();
		Field "height" :int();
		Field "format" :string();
...
AssetLibraryModule.registerAssetLoader ( "render_target", RenderTargetTextureLoader )
