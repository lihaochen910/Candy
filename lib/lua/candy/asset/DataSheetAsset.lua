...
-- module
local DataSheetAssetModule = {}

local DataSheetAccessor, DataSheetDictAccessor, DataSheetListAccessor, DataSheetListRowAccessor

---@class DataSheetAccessor
DataSheetAccessor = CLASS: DataSheetAccessor ()
	:MODEL {}
...
DataSheetDictAccessor = CLASS:DataSheetDictAccessor ( DataSheetAccessor )
	:MODEL {}
...
DataSheetListAccessor = CLASS: DataSheetListAccessor ( DataSheetAccessor )
	:MODEL {}
...
local DataSheetListRowAccessor = CLASS: DataSheetListRowAccessor ()
...
AssetLibraryModule.registerAssetLoader ( "data_xls", XLSDataLoader )
AssetLibraryModule.registerAssetLoader ( "data_sheet", DataSheetLoader )

DataSheetAssetModule.DataSheetAccessor = DataSheetAccessor
DataSheetAssetModule.DataSheetDictAccessor = DataSheetDictAccessor
DataSheetAssetModule.DataSheetListAccessor = DataSheetListAccessor
DataSheetAssetModule.DataSheetListRowAccessor = DataSheetListRowAccessor

return DataSheetAssetModule