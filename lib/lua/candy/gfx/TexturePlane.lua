...
local TexturePlane = CLASS: TexturePlane ( GraphicsPropComponent )
	:MODEL {
...
ComponentModule.registerComponent ( "TexturePlane", TexturePlane )
ComponentModule.registerEntityWithComponent ( "TexturePlane", TexturePlane )
