...
SignalModule.connectSignalFunc ( 'layer.update',  function ( ... ) cameraManager:onLayerUpdate ( ... ) end )
...
CameraManagerModule.CameraManager = CameraManager
CameraManagerModule.getCameraManager = getCameraManager
