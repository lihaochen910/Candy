...
-- module
local NamedTileMapModule = {}

---@class NamedTileGrid : TileMapGrid
local NamedTileGrid = CLASS: NamedTileGrid ( TileMapGrid )
	:MODEL {}
...
function NamedTileGrid:getTile ( x, y )
...
local NamedTileMapLayer = CLASS: NamedTileMapLayer ( TileMapLayer )
	:MODEL {}
...
NamedTileMapModule.NamedTileGrid = NamedTileGrid
NamedTileMapModule.NamedTileMapLayer = NamedTileMapLayer

return NamedTileMapModule