...
_CANDY_PACKAGE_NAME = '__candy__'
_INFO_FILE_NAME = '__candy__.json'

_CANDY_MODULE = ModuleType(_CANDY_PACKAGE_NAME)
sys.modules[_CANDY_PACKAGE_NAME] = _CANDY_MODULE
...
class Package(object):
	def __init__(self, name, path, settings):
		...
		self.moduleName = _CANDY_PACKAGE_NAME + '.' + name
		self.loaded = False
	...
	def load(self):
		...
		self.loaded = True
		setattr(_CANDY_MODULE, self.name, self.loadedModule)
		return True
