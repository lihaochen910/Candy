...
from moai.CandyRuntime import isCandyInstance
from sceneEditor.SceneEditor      import SceneEditorModule, getSceneSelectionManager
...
class LayerManager( SceneEditorModule ):
	...
	def onLoad( self ):
		...
		self.delegate.load( self.getApp().getPath( 'sceneEditor/LayerEditor/LayerEditor.lua' ) )
